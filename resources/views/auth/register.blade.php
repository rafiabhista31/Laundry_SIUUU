          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form action="{{ route('register.store')}}" method="post">
                ...
                <div class="mb-3">
                  <input type="username" class="form-control" name="username" placeholder="Email" aria-label="Email">
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" name="password" placeholder="Password" aria-label="Password">
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" name="telepon" placeholder="Telepon" aria-label="Name">
                </div>
